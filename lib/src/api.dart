...
import 'package:flutter_discord_client/src/auth/api_key_auth.dart';
import 'package:flutter_discord_client/src/auth/basic_auth.dart';
import 'package:flutter_discord_client/src/auth/bearer_auth.dart';
import 'package:flutter_discord_client/src/auth/oauth.dart';
import 'package:flutter_discord_client/src/api/default_api.dart';

class FlutterDiscordClient {
  static const String basePath = r'https://discord.com/api/v10';

  final Dio dio;
  FlutterDiscordClient({
    Dio? dio,
