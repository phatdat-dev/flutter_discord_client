...
part 'application_command_integer_option_response.g.dart';
...
class ApplicationCommandIntegerOptionResponse {
  /// Returns a new [ApplicationCommandIntegerOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandIntegerOptionResponse &&
  ...
  factory ApplicationCommandIntegerOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandIntegerOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandIntegerOptionResponseToJson(this);
