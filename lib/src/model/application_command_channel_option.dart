...
part 'application_command_channel_option.g.dart';
...
class ApplicationCommandChannelOption {
  /// Returns a new [ApplicationCommandChannelOption] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandChannelOption &&
  ...
  factory ApplicationCommandChannelOption.fromJson(Map<String, dynamic> json) => _$ApplicationCommandChannelOptionFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandChannelOptionToJson(this);
