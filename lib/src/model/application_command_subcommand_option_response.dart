...
part 'application_command_subcommand_option_response.g.dart';
...
class ApplicationCommandSubcommandOptionResponse {
  /// Returns a new [ApplicationCommandSubcommandOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandSubcommandOptionResponse &&
  ...
  factory ApplicationCommandSubcommandOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandSubcommandOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandSubcommandOptionResponseToJson(this);
