...
part 'default_keyword_rule_response.g.dart';
...
class DefaultKeywordRuleResponse {
  /// Returns a new [DefaultKeywordRuleResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is DefaultKeywordRuleResponse &&
  ...
  factory DefaultKeywordRuleResponse.fromJson(Map<String, dynamic> json) => _$DefaultKeywordRuleResponseFromJson(json);

  Map<String, dynamic> toJson() => _$DefaultKeywordRuleResponseToJson(this);
