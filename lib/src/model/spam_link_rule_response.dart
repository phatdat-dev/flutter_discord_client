...
part 'spam_link_rule_response.g.dart';
...
class SpamLinkRuleResponse {
  /// Returns a new [SpamLinkRuleResponse] instance.
  ...
  factory SpamLinkRuleResponse.fromJson(Map<String, dynamic> json) => _$SpamLinkRuleResponseFromJson(json);

  Map<String, dynamic> toJson() => _$SpamLinkRuleResponseToJson(this);
