...
part 'application_command_channel_option_response.g.dart';
...
class ApplicationCommandChannelOptionResponse {
  /// Returns a new [ApplicationCommandChannelOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandChannelOptionResponse &&
  ...
  factory ApplicationCommandChannelOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandChannelOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandChannelOptionResponseToJson(this);
