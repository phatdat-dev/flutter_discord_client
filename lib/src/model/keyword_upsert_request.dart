...
part 'keyword_upsert_request.g.dart';
...
class KeywordUpsertRequest {
  /// Returns a new [KeywordUpsertRequest] instance.
  ...
  factory KeywordUpsertRequest.fromJson(Map<String, dynamic> json) => _$KeywordUpsertRequestFromJson(json);

  Map<String, dynamic> toJson() => _$KeywordUpsertRequestToJson(this);
