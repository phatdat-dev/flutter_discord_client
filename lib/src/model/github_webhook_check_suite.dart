...
part 'github_webhook_check_suite.g.dart';
...
class GithubWebhookCheckSuite {
  /// Returns a new [GithubWebhookCheckSuite] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is GithubWebhookCheckSuite &&
  ...
  factory GithubWebhookCheckSuite.fromJson(Map<String, dynamic> json) => _$GithubWebhookCheckSuiteFromJson(json);

  Map<String, dynamic> toJson() => _$GithubWebhookCheckSuiteToJson(this);
