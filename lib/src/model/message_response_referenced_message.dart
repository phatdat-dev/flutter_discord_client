...
part 'message_response_referenced_message.g.dart';
...
class MessageResponseReferencedMessage {
  /// Returns a new [MessageResponseReferencedMessage] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is MessageResponseReferencedMessage &&
  ...
  factory MessageResponseReferencedMessage.fromJson(Map<String, dynamic> json) => _$MessageResponseReferencedMessageFromJson(json);

  Map<String, dynamic> toJson() => _$MessageResponseReferencedMessageToJson(this);
