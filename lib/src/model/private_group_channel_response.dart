...
part 'private_group_channel_response.g.dart';
...
class PrivateGroupChannelResponse {
  /// Returns a new [PrivateGroupChannelResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is PrivateGroupChannelResponse &&
  ...
  factory PrivateGroupChannelResponse.fromJson(Map<String, dynamic> json) => _$PrivateGroupChannelResponseFromJson(json);

  Map<String, dynamic> toJson() => _$PrivateGroupChannelResponseToJson(this);
