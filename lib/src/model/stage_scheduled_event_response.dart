...
part 'stage_scheduled_event_response.g.dart';
...
class StageScheduledEventResponse {
  /// Returns a new [StageScheduledEventResponse] instance.
  ...
  final StageScheduledEventResponseEntityMetadata? entityMetadata;
  ...
  bool operator ==(Object other) {
      ...
      other is StageScheduledEventResponse &&
  ...
  factory StageScheduledEventResponse.fromJson(Map<String, dynamic> json) => _$StageScheduledEventResponseFromJson(json);

  Map<String, dynamic> toJson() => _$StageScheduledEventResponseToJson(this);
