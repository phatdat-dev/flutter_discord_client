...
part 'sdk_message_request.g.dart';
...
class SDKMessageRequest {
  /// Returns a new [SDKMessageRequest] instance.
  SDKMessageRequest({
  ...
  factory SDKMessageRequest.fromJson(Map<String, dynamic> json) => _$SDKMessageRequestFromJson(json);

  Map<String, dynamic> toJson() => _$SDKMessageRequestToJson(this);
