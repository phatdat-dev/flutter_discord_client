...
part 'application_command_boolean_option_response.g.dart';
...
class ApplicationCommandBooleanOptionResponse {
  /// Returns a new [ApplicationCommandBooleanOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandBooleanOptionResponse &&
  ...
  factory ApplicationCommandBooleanOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandBooleanOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandBooleanOptionResponseToJson(this);
