...
part 'keyword_upsert_request_partial.g.dart';
...
class KeywordUpsertRequestPartial {
  /// Returns a new [KeywordUpsertRequestPartial] instance.
  ...
  final KeywordUpsertRequestTriggerMetadata? triggerMetadata;
  ...
  bool operator ==(Object other) {
      ...
      other is KeywordUpsertRequestPartial &&
  ...
  factory KeywordUpsertRequestPartial.fromJson(Map<String, dynamic> json) => _$KeywordUpsertRequestPartialFromJson(json);

  Map<String, dynamic> toJson() => _$KeywordUpsertRequestPartialToJson(this);
