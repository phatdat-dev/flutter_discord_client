...
part 'base_create_message_create_request_poll.g.dart';
...
class BaseCreateMessageCreateRequestPoll {
  /// Returns a new [BaseCreateMessageCreateRequestPoll] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is BaseCreateMessageCreateRequestPoll &&
  ...
  factory BaseCreateMessageCreateRequestPoll.fromJson(Map<String, dynamic> json) => _$BaseCreateMessageCreateRequestPollFromJson(json);

  Map<String, dynamic> toJson() => _$BaseCreateMessageCreateRequestPollToJson(this);
