...
part 'application_command_role_option.g.dart';
...
class ApplicationCommandRoleOption {
  /// Returns a new [ApplicationCommandRoleOption] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandRoleOption &&
  ...
  factory ApplicationCommandRoleOption.fromJson(Map<String, dynamic> json) => _$ApplicationCommandRoleOptionFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandRoleOptionToJson(this);
