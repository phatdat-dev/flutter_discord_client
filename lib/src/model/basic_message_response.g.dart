...
part of 'basic_message_response.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$BasicMessageResponseCWProxy {
  BasicMessageResponse type(MessageType type);

  BasicMessageResponse content(String content);

  BasicMessageResponse mentions(List<UserResponse> mentions);

  BasicMessageResponse mentionRoles(Set<String> mentionRoles);

  BasicMessageResponse attachments(List<MessageAttachmentResponse> attachments);

  BasicMessageResponse embeds(List<MessageEmbedResponse> embeds);

  BasicMessageResponse timestamp(DateTime timestamp);

  BasicMessageResponse editedTimestamp(DateTime? editedTimestamp);

  BasicMessageResponse flags(int flags);

  BasicMessageResponse components(
    List<BasicMessageResponseComponentsInner> components,
  );

  BasicMessageResponse stickers(List<GetSticker200Response>? stickers);

  BasicMessageResponse stickerItems(
    List<MessageStickerItemResponse>? stickerItems,
  );

  BasicMessageResponse id(String id);

  BasicMessageResponse channelId(String channelId);

  BasicMessageResponse author(UserResponse author);

  BasicMessageResponse pinned(bool pinned);

  BasicMessageResponse mentionEveryone(bool mentionEveryone);

  BasicMessageResponse tts(bool tts);

  BasicMessageResponse call(MessageCallResponse? call);

  BasicMessageResponse activity(Object? activity);

  BasicMessageResponse application(BasicApplicationResponse? application);

  BasicMessageResponse applicationId(String? applicationId);

  BasicMessageResponse interaction(MessageInteractionResponse? interaction);

  BasicMessageResponse nonce(BasicMessageResponseNonce? nonce);

  BasicMessageResponse webhookId(String? webhookId);

  BasicMessageResponse messageReference(
    MessageReferenceResponse? messageReference,
  );

  BasicMessageResponse thread(ThreadResponse? thread);

  BasicMessageResponse mentionChannels(
    List<BasicMessageResponseMentionChannelsInner>? mentionChannels,
  );

  BasicMessageResponse roleSubscriptionData(
    MessageRoleSubscriptionDataResponse? roleSubscriptionData,
  );

  BasicMessageResponse purchaseNotification(
    PurchaseNotificationResponse? purchaseNotification,
  );

  BasicMessageResponse position(int? position);

  BasicMessageResponse resolved(ResolvedObjectsResponse? resolved);

  BasicMessageResponse poll(PollResponse? poll);

  BasicMessageResponse sharedClientTheme(
    BasicMessageResponseSharedClientTheme? sharedClientTheme,
  );

  BasicMessageResponse interactionMetadata(
    BasicMessageResponseInteractionMetadata? interactionMetadata,
  );

  BasicMessageResponse messageSnapshots(
    List<MessageSnapshotResponse>? messageSnapshots,
  );

  /// This function **does support** nullification of nullable fields. All `null` values passed to `non-nullable` fields will be ignored. You can also use `BasicMessageResponse(...).copyWith.fieldName(...)` to override fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
  /// BasicMessageResponse(...).copyWith(id: 12, name: "My name")
  /// ````
  BasicMessageResponse call({
    MessageType type,
    String content,
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfBasicMessageResponse.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfBasicMessageResponse.copyWith.fieldName(...)`
class _$BasicMessageResponseCWProxyImpl
    implements _$BasicMessageResponseCWProxy {
  const _$BasicMessageResponseCWProxyImpl(this._value);

  final BasicMessageResponse _value;

  @override
  BasicMessageResponse type(MessageType type) => this(type: type);

  @override
  BasicMessageResponse content(String content) => this(content: content);
  ...
  @override
  BasicMessageResponse attachments(
    List<MessageAttachmentResponse> attachments,
  ...
  @override
  BasicMessageResponse flags(int flags) => this(flags: flags);
  ...
  @override
  BasicMessageResponse id(String id) => this(id: id);
  ...
  @override
  BasicMessageResponse author(UserResponse author) => this(author: author);

  @override
  BasicMessageResponse pinned(bool pinned) => this(pinned: pinned);
  ...
  @override
  BasicMessageResponse tts(bool tts) => this(tts: tts);

  @override
  BasicMessageResponse call(MessageCallResponse? call) => this(call: call);

  @override
  BasicMessageResponse activity(Object? activity) => this(activity: activity);
  ...
  @override
  BasicMessageResponse thread(ThreadResponse? thread) => this(thread: thread);
  ...
  @override
  BasicMessageResponse position(int? position) => this(position: position);
  ...
  @override
  BasicMessageResponse poll(PollResponse? poll) => this(poll: poll);
...
extension $BasicMessageResponseCopyWith on BasicMessageResponse {
  /// Returns a callable class that can be used as follows: `instanceOfBasicMessageResponse.copyWith(...)` or like so:`instanceOfBasicMessageResponse.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$BasicMessageResponseCWProxy get copyWith =>
      _$BasicMessageResponseCWProxyImpl(this);
}
...
BasicMessageResponse _$BasicMessageResponseFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = BasicMessageResponse(
      type: $checkedConvert(
        'type',
...
Map<String, dynamic> _$BasicMessageResponseToJson(
  BasicMessageResponse instance,
) => <String, dynamic>{
