...
part 'update_guild_scheduled_event_request.g.dart';
...
class UpdateGuildScheduledEventRequest {
  /// Returns a new [UpdateGuildScheduledEventRequest] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is UpdateGuildScheduledEventRequest &&
  ...
  factory UpdateGuildScheduledEventRequest.fromJson(Map<String, dynamic> json) => _$UpdateGuildScheduledEventRequestFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateGuildScheduledEventRequestToJson(this);
