...
part 'application_command_subcommand_group_option.g.dart';
...
class ApplicationCommandSubcommandGroupOption {
  /// Returns a new [ApplicationCommandSubcommandGroupOption] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandSubcommandGroupOption &&
  ...
  factory ApplicationCommandSubcommandGroupOption.fromJson(Map<String, dynamic> json) => _$ApplicationCommandSubcommandGroupOptionFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandSubcommandGroupOptionToJson(this);
