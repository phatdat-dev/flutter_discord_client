...
part 'ml_spam_upsert_request_partial.g.dart';
...
class MLSpamUpsertRequestPartial {
  /// Returns a new [MLSpamUpsertRequestPartial] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is MLSpamUpsertRequestPartial &&
  ...
  factory MLSpamUpsertRequestPartial.fromJson(Map<String, dynamic> json) => _$MLSpamUpsertRequestPartialFromJson(json);

  Map<String, dynamic> toJson() => _$MLSpamUpsertRequestPartialToJson(this);
