...
part 'execute_webhook_request.g.dart';
...
class ExecuteWebhookRequest {
  /// Returns a new [ExecuteWebhookRequest] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ExecuteWebhookRequest &&
  ...
  factory ExecuteWebhookRequest.fromJson(Map<String, dynamic> json) => _$ExecuteWebhookRequestFromJson(json);

  Map<String, dynamic> toJson() => _$ExecuteWebhookRequestToJson(this);
