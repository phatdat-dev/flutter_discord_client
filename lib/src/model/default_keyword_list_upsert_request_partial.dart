...
part 'default_keyword_list_upsert_request_partial.g.dart';
...
class DefaultKeywordListUpsertRequestPartial {
  /// Returns a new [DefaultKeywordListUpsertRequestPartial] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is DefaultKeywordListUpsertRequestPartial &&
  ...
  factory DefaultKeywordListUpsertRequestPartial.fromJson(Map<String, dynamic> json) => _$DefaultKeywordListUpsertRequestPartialFromJson(json);

  Map<String, dynamic> toJson() => _$DefaultKeywordListUpsertRequestPartialToJson(this);
