...
part 'update_guild_channel_request_partial.g.dart';
...
class UpdateGuildChannelRequestPartial {
  /// Returns a new [UpdateGuildChannelRequestPartial] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is UpdateGuildChannelRequestPartial &&
  ...
  factory UpdateGuildChannelRequestPartial.fromJson(Map<String, dynamic> json) => _$UpdateGuildChannelRequestPartialFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateGuildChannelRequestPartialToJson(this);
