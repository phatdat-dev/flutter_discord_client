...
part 'voice_scheduled_event_create_request.g.dart';
...
class VoiceScheduledEventCreateRequest {
  /// Returns a new [VoiceScheduledEventCreateRequest] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is VoiceScheduledEventCreateRequest &&
  ...
  factory VoiceScheduledEventCreateRequest.fromJson(Map<String, dynamic> json) => _$VoiceScheduledEventCreateRequestFromJson(json);

  Map<String, dynamic> toJson() => _$VoiceScheduledEventCreateRequestToJson(this);
