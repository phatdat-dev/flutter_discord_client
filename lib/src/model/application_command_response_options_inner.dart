...
part 'application_command_response_options_inner.g.dart';
...
class ApplicationCommandResponseOptionsInner {
  /// Returns a new [ApplicationCommandResponseOptionsInner] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandResponseOptionsInner &&
  ...
  factory ApplicationCommandResponseOptionsInner.fromJson(Map<String, dynamic> json) => _$ApplicationCommandResponseOptionsInnerFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandResponseOptionsInnerToJson(this);
