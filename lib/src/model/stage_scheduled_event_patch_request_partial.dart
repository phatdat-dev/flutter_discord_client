...
part 'stage_scheduled_event_patch_request_partial.g.dart';
...
class StageScheduledEventPatchRequestPartial {
  /// Returns a new [StageScheduledEventPatchRequestPartial] instance.
  ...
  final StageScheduledEventPatchRequestPartialEntityType? entityType;
  ...
  bool operator ==(Object other) {
      ...
      other is StageScheduledEventPatchRequestPartial &&
  ...
  factory StageScheduledEventPatchRequestPartial.fromJson(Map<String, dynamic> json) => _$StageScheduledEventPatchRequestPartialFromJson(json);

  Map<String, dynamic> toJson() => _$StageScheduledEventPatchRequestPartialToJson(this);
