...
part 'update_auto_moderation_rule_request.g.dart';
...
class UpdateAutoModerationRuleRequest {
  /// Returns a new [UpdateAutoModerationRuleRequest] instance.
  ...
  final MentionSpamUpsertRequestTriggerMetadata? triggerMetadata;
  ...
  bool operator ==(Object other) {
      ...
      other is UpdateAutoModerationRuleRequest &&
  ...
  factory UpdateAutoModerationRuleRequest.fromJson(Map<String, dynamic> json) => _$UpdateAutoModerationRuleRequestFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateAutoModerationRuleRequestToJson(this);
