...
part 'application_command_mentionable_option_response.g.dart';
...
class ApplicationCommandMentionableOptionResponse {
  /// Returns a new [ApplicationCommandMentionableOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandMentionableOptionResponse &&
  ...
  factory ApplicationCommandMentionableOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandMentionableOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandMentionableOptionResponseToJson(this);
