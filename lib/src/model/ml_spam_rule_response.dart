...
part 'ml_spam_rule_response.g.dart';
...
class MLSpamRuleResponse {
  /// Returns a new [MLSpamRuleResponse] instance.
  MLSpamRuleResponse({
  ...
  factory MLSpamRuleResponse.fromJson(Map<String, dynamic> json) => _$MLSpamRuleResponseFromJson(json);

  Map<String, dynamic> toJson() => _$MLSpamRuleResponseToJson(this);
