...
part 'invite_channel_response.g.dart';
...
class InviteChannelResponse {
  /// Returns a new [InviteChannelResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is InviteChannelResponse &&
  ...
  factory InviteChannelResponse.fromJson(Map<String, dynamic> json) => _$InviteChannelResponseFromJson(json);

  Map<String, dynamic> toJson() => _$InviteChannelResponseToJson(this);
