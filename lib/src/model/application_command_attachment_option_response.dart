...
part 'application_command_attachment_option_response.g.dart';
...
class ApplicationCommandAttachmentOptionResponse {
  /// Returns a new [ApplicationCommandAttachmentOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandAttachmentOptionResponse &&
  ...
  factory ApplicationCommandAttachmentOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandAttachmentOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandAttachmentOptionResponseToJson(this);
