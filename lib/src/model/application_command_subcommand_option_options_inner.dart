...
part 'application_command_subcommand_option_options_inner.g.dart';
...
class ApplicationCommandSubcommandOptionOptionsInner {
  /// Returns a new [ApplicationCommandSubcommandOptionOptionsInner] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandSubcommandOptionOptionsInner &&
  ...
  factory ApplicationCommandSubcommandOptionOptionsInner.fromJson(Map<String, dynamic> json) => _$ApplicationCommandSubcommandOptionOptionsInnerFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandSubcommandOptionOptionsInnerToJson(this);
