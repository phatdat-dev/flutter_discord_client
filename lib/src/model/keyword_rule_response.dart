...
part 'keyword_rule_response.g.dart';
...
class KeywordRuleResponse {
  /// Returns a new [KeywordRuleResponse] instance.
  KeywordRuleResponse({
  ...
  factory KeywordRuleResponse.fromJson(Map<String, dynamic> json) => _$KeywordRuleResponseFromJson(json);

  Map<String, dynamic> toJson() => _$KeywordRuleResponseToJson(this);
