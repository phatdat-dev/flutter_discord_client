...
part 'mention_spam_upsert_request_partial.g.dart';
...
class MentionSpamUpsertRequestPartial {
  /// Returns a new [MentionSpamUpsertRequestPartial] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is MentionSpamUpsertRequestPartial &&
  ...
  factory MentionSpamUpsertRequestPartial.fromJson(Map<String, dynamic> json) => _$MentionSpamUpsertRequestPartialFromJson(json);

  Map<String, dynamic> toJson() => _$MentionSpamUpsertRequestPartialToJson(this);
