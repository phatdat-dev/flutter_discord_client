...
part 'application_command_subcommand_group_option_response.g.dart';
...
class ApplicationCommandSubcommandGroupOptionResponse {
  /// Returns a new [ApplicationCommandSubcommandGroupOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandSubcommandGroupOptionResponse &&
  ...
  factory ApplicationCommandSubcommandGroupOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandSubcommandGroupOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandSubcommandGroupOptionResponseToJson(this);
