...
abstract class _$GuildResponseCWProxy {
  GuildResponse id(String id);

  GuildResponse name(String name);

  GuildResponse icon(String? icon);

  GuildResponse description(String? description);

  GuildResponse homeHeader(String? homeHeader);

  GuildResponse splash(String? splash);

  GuildResponse discoverySplash(String? discoverySplash);

  GuildResponse features(Set<GuildFeatures> features);

  GuildResponse banner(String? banner);

  GuildResponse ownerId(String ownerId);

  GuildResponse applicationId(
    GetEntitlementsSkuIdsParameterOneOfInner? applicationId,
  );

  GuildResponse region(String region);

  GuildResponse afkChannelId(
    GetEntitlementsSkuIdsParameterOneOfInner? afkChannelId,
  );

  GuildResponse afkTimeout(AfkTimeouts afkTimeout);

  GuildResponse systemChannelId(
    GetEntitlementsSkuIdsParameterOneOfInner? systemChannelId,
  );

  GuildResponse systemChannelFlags(int systemChannelFlags);

  GuildResponse widgetEnabled(bool widgetEnabled);

  GuildResponse widgetChannelId(
    GetEntitlementsSkuIdsParameterOneOfInner? widgetChannelId,
  );

  GuildResponse verificationLevel(VerificationLevels verificationLevel);

  GuildResponse roles(List<GuildRoleResponse> roles);

  GuildResponse defaultMessageNotifications(
    UserNotificationSettings defaultMessageNotifications,
  );

  GuildResponse mfaLevel(GuildMFALevel mfaLevel);

  GuildResponse explicitContentFilter(
    GuildExplicitContentFilterTypes explicitContentFilter,
  );

  GuildResponse maxPresences(int? maxPresences);

  GuildResponse maxMembers(int maxMembers);

  GuildResponse maxStageVideoChannelUsers(int maxStageVideoChannelUsers);

  GuildResponse maxVideoChannelUsers(int maxVideoChannelUsers);

  GuildResponse vanityUrlCode(String? vanityUrlCode);

  GuildResponse premiumTier(PremiumGuildTiers premiumTier);

  GuildResponse premiumSubscriptionCount(int premiumSubscriptionCount);

  GuildResponse preferredLocale(AvailableLocalesEnum preferredLocale);

  GuildResponse rulesChannelId(
    GetEntitlementsSkuIdsParameterOneOfInner? rulesChannelId,
  );

  GuildResponse safetyAlertsChannelId(
    GetEntitlementsSkuIdsParameterOneOfInner? safetyAlertsChannelId,
  );

  GuildResponse publicUpdatesChannelId(
    GetEntitlementsSkuIdsParameterOneOfInner? publicUpdatesChannelId,
  );

  GuildResponse premiumProgressBarEnabled(bool premiumProgressBarEnabled);

  GuildResponse nsfw(bool nsfw);

  GuildResponse nsfwLevel(GuildNSFWContentLevel nsfwLevel);

  GuildResponse emojis(List<EmojiResponse> emojis);

  GuildResponse stickers(List<GuildStickerResponse> stickers);

  /// This function **does support** nullification of nullable fields. All `null` values passed to `non-nullable` fields will be ignored. You can also use `GuildResponse(...).copyWith.fieldName(...)` to override fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
  /// GuildResponse(...).copyWith(id: 12, name: "My name")
  /// ````
  GuildResponse call({
    String id,
    String name,
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfGuildResponse.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfGuildResponse.copyWith.fieldName(...)`
class _$GuildResponseCWProxyImpl implements _$GuildResponseCWProxy {
  const _$GuildResponseCWProxyImpl(this._value);

  final GuildResponse _value;

  @override
  GuildResponse id(String id) => this(id: id);

  @override
  GuildResponse name(String name) => this(name: name);

  @override
  GuildResponse icon(String? icon) => this(icon: icon);
  ...
  @override
  GuildResponse homeHeader(String? homeHeader) => this(homeHeader: homeHeader);

  @override
  GuildResponse splash(String? splash) => this(splash: splash);
  ...
  @override
  GuildResponse banner(String? banner) => this(banner: banner);

  @override
  GuildResponse ownerId(String ownerId) => this(ownerId: ownerId);
  ...
  @override
  GuildResponse region(String region) => this(region: region);
  ...
  @override
  GuildResponse roles(List<GuildRoleResponse> roles) => this(roles: roles);
  ...
  @override
  GuildResponse mfaLevel(GuildMFALevel mfaLevel) => this(mfaLevel: mfaLevel);
  ...
  @override
  GuildResponse maxMembers(int maxMembers) => this(maxMembers: maxMembers);
  ...
  @override
  GuildResponse nsfw(bool nsfw) => this(nsfw: nsfw);
  ...
  @override
  GuildResponse emojis(List<EmojiResponse> emojis) => this(emojis: emojis);
...
extension $GuildResponseCopyWith on GuildResponse {
  /// Returns a callable class that can be used as follows: `instanceOfGuildResponse.copyWith(...)` or like so:`instanceOfGuildResponse.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$GuildResponseCWProxy get copyWith => _$GuildResponseCWProxyImpl(this);
}
