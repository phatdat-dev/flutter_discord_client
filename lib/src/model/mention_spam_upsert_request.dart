...
part 'mention_spam_upsert_request.g.dart';
...
class MentionSpamUpsertRequest {
  /// Returns a new [MentionSpamUpsertRequest] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is MentionSpamUpsertRequest &&
  ...
  factory MentionSpamUpsertRequest.fromJson(Map<String, dynamic> json) => _$MentionSpamUpsertRequestFromJson(json);

  Map<String, dynamic> toJson() => _$MentionSpamUpsertRequestToJson(this);
