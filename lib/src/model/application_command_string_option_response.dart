...
part 'application_command_string_option_response.g.dart';
...
class ApplicationCommandStringOptionResponse {
  /// Returns a new [ApplicationCommandStringOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandStringOptionResponse &&
  ...
  factory ApplicationCommandStringOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandStringOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandStringOptionResponseToJson(this);
