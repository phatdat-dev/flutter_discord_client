...
part 'github_webhook_check_run.g.dart';
...
class GithubWebhookCheckRun {
  /// Returns a new [GithubWebhookCheckRun] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is GithubWebhookCheckRun &&
  ...
  factory GithubWebhookCheckRun.fromJson(Map<String, dynamic> json) => _$GithubWebhookCheckRunFromJson(json);

  Map<String, dynamic> toJson() => _$GithubWebhookCheckRunToJson(this);
