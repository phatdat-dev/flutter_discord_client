...
class EntitlementResponse {
  ...
  factory EntitlementResponse.fromJson(Map<String, dynamic> json) => _$EntitlementResponseFromJson(json);

  Map<String, dynamic> toJson() => _$EntitlementResponseToJson(this);
