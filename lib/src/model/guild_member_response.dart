...
class GuildMemberResponse {
  /// Returns a new [GuildMemberResponse] instance.
  GuildMemberResponse({
  ...
  factory GuildMemberResponse.fromJson(Map<String, dynamic> json) => _$GuildMemberResponseFromJson(json);

  Map<String, dynamic> toJson() => _$GuildMemberResponseToJson(this);
