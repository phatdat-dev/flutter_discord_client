...
part 'guild_onboarding_response.g.dart';
...
class GuildOnboardingResponse {
  /// Returns a new [GuildOnboardingResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is GuildOnboardingResponse &&
  ...
  factory GuildOnboardingResponse.fromJson(Map<String, dynamic> json) => _$GuildOnboardingResponseFromJson(json);

  Map<String, dynamic> toJson() => _$GuildOnboardingResponseToJson(this);
