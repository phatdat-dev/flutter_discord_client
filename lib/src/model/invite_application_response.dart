...
part 'invite_application_response.g.dart';
...
class InviteApplicationResponse {
  /// Returns a new [InviteApplicationResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is InviteApplicationResponse &&
  ...
  factory InviteApplicationResponse.fromJson(Map<String, dynamic> json) => _$InviteApplicationResponseFromJson(json);

  Map<String, dynamic> toJson() => _$InviteApplicationResponseToJson(this);
