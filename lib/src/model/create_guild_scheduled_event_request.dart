...
part 'create_guild_scheduled_event_request.g.dart';
...
class CreateGuildScheduledEventRequest {
  /// Returns a new [CreateGuildScheduledEventRequest] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is CreateGuildScheduledEventRequest &&
  ...
  factory CreateGuildScheduledEventRequest.fromJson(Map<String, dynamic> json) => _$CreateGuildScheduledEventRequestFromJson(json);

  Map<String, dynamic> toJson() => _$CreateGuildScheduledEventRequestToJson(this);
