...
part 'guild_template_response_creator.g.dart';
...
class GuildTemplateResponseCreator {
  /// Returns a new [GuildTemplateResponseCreator] instance.
  GuildTemplateResponseCreator({
  ...
  bool operator ==(Object other) {
      ...
      other is GuildTemplateResponseCreator &&
  ...
  factory GuildTemplateResponseCreator.fromJson(Map<String, dynamic> json) => _$GuildTemplateResponseCreatorFromJson(json);

  Map<String, dynamic> toJson() => _$GuildTemplateResponseCreatorToJson(this);
