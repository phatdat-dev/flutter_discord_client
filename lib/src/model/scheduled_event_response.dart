...
part 'scheduled_event_response.g.dart';
...
class ScheduledEventResponse {
  /// Returns a new [ScheduledEventResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ScheduledEventResponse &&
  ...
  factory ScheduledEventResponse.fromJson(Map<String, dynamic> json) => _$ScheduledEventResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ScheduledEventResponseToJson(this);
