...
class UserPIIResponse {
  /// Returns a new [UserPIIResponse] instance.
  UserPIIResponse({
  ...
  factory UserPIIResponse.fromJson(Map<String, dynamic> json) => _$UserPIIResponseFromJson(json);

  Map<String, dynamic> toJson() => _$UserPIIResponseToJson(this);
