...
part 'application_command_user_option_response.g.dart';
...
class ApplicationCommandUserOptionResponse {
  /// Returns a new [ApplicationCommandUserOptionResponse] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is ApplicationCommandUserOptionResponse &&
  ...
  factory ApplicationCommandUserOptionResponse.fromJson(Map<String, dynamic> json) => _$ApplicationCommandUserOptionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApplicationCommandUserOptionResponseToJson(this);
