...
part 'incoming_webhook_interaction_request.g.dart';
...
class IncomingWebhookInteractionRequest {
  /// Returns a new [IncomingWebhookInteractionRequest] instance.
  ...
  bool operator ==(Object other) {
      ...
      other is IncomingWebhookInteractionRequest &&
  ...
  factory IncomingWebhookInteractionRequest.fromJson(Map<String, dynamic> json) => _$IncomingWebhookInteractionRequestFromJson(json);

  Map<String, dynamic> toJson() => _$IncomingWebhookInteractionRequestToJson(this);
