...
class GuildResponse {
  /// Returns a new [GuildResponse] instance.
  GuildResponse({
  ...
  factory GuildResponse.fromJson(Map<String, dynamic> json) => _$GuildResponseFromJson(json);

  Map<String, dynamic> toJson() => _$GuildResponseToJson(this);
